...
from amt.models.relationships import role_and_organizations, users_and_organizations
...
class Organization(Base):
    ...
    roles: Mapped[list["Role"]] = relationship(  # pyright: ignore[reportUnknownVariableType, reportUndefinedVariable] #noqa
        secondary=role_and_organizations, back_populates="organizations", lazy="selectin"
    )
