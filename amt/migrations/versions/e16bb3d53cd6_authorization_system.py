...
def upgrade() -> None:
        ...
        [
            {
                ...
                "verbs": [AuthorizationVerb.CREATE, AuthorizationVerb.READ, AuthorizationVerb.UPDATE],
                "role_id": 1,
            },
            {
                "id": 2,
                "resource": AuthorizationResource.ORGANIZATION_ALGORITHM,
                "verbs": [
            ...
            {
                "id": 3,
                "resource": AuthorizationResource.ORGANIZATION_MEMBER,
                "verbs": [
                    AuthorizationVerb.LIST,
                    AuthorizationVerb.CREATE,
                    AuthorizationVerb.UPDATE,
            ...
            },
            {
                "id": 4,
                "resource": AuthorizationResource.ORGANIZATION_INFO,
                "verbs": [AuthorizationVerb.READ],
                "role_id": 2,
            },
            {
                "id": 5,
                "resource": AuthorizationResource.ORGANIZATION_ALGORITHM,
                "verbs": [AuthorizationVerb.LIST, AuthorizationVerb.CREATE],
                "role_id": 2,
            },
            {
                "id": 6,
                "resource": AuthorizationResource.ORGANIZATION_MEMBER,
                "verbs": [AuthorizationVerb.LIST],
                "role_id": 2,
            },
            {
                "id": 7,
            ...
            {
                "id": 10,
                "resource": AuthorizationResource.ALGORITHM,
                "verbs": [AuthorizationVerb.CREATE, AuthorizationVerb.READ, AuthorizationVerb.DELETE],
                "role_id": 4,
            },
            {
                "id": 11,
                "resource": AuthorizationResource.ALGORITHM_SYSTEMCARD,
                "verbs": [AuthorizationVerb.READ, AuthorizationVerb.CREATE, AuthorizationVerb.UPDATE],
                "role_id": 4,
            },
            {
                "id": 12,
                "resource": AuthorizationResource.ALGORITHM_MEMBER,
                "verbs": [
                    AuthorizationVerb.CREATE,
            ...
            },
            {
                "id": 13,
                "resource": AuthorizationResource.ALGORITHM,
                "verbs": [AuthorizationVerb.READ, AuthorizationVerb.CREATE],
                "role_id": 5,
            },
            {
                "id": 14,
    ...
    op.bulk_insert(authorization_table, authorizations)
