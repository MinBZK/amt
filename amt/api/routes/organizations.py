...
async def remove_member(
    ...
    #  also check if it is the only maintainer of an algorithm and fail if true
    algorithm_authorizations: Sequence[Authorization] = await authorizations_service.find_all_by_user_and_type(
        user_id, AuthorizationType.ALGORITHM
    )
