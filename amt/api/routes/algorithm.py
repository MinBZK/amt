...
async def get_algorithm_members(algorithm: Algorithm, authorizations_service: AuthorizationsService) -> list[User]:
    return [
        user
        for user, _, _ in await authorizations_service.find_all(
...
async def get_measure(
    ...
    members = [
        user for user, _, _ in await authorizations_service.find_all(search=search, sort=sort_by, filters=filters)
    ]
