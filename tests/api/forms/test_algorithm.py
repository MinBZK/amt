...
async def test_get_organization_select_field(mocker: MockerFixture) -> None:
    ...
    # when
    result = await get_organization_select_field(_, organization_id, organizations_service, user_id)
...
async def test_get_algorithm_form(mocker: MockerFixture) -> None:
    ...
    # when
    result = await get_algorithm_form(form_id, translations, organizations_service, user_id, organization_id)
...
async def test_get_algorithm_form_no_user_id(mocker: MockerFixture) -> None:
    ...
    with pytest.raises(ValueError, match="user_id is required"):
        await get_algorithm_form(form_id, translations, organizations_service, user_id, organization_id)
