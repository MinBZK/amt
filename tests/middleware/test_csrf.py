...
@pytest.mark.asyncio
async def test_cookie_only_csrf_protect_validate_csrf_missing_token() -> None:
    # given
    csrf_protect = CookieOnlyCsrfProtect()
    csrf_protect._secret_key = "test-secret"  # pyright: ignore[reportPrivateUsage] # noqa: S105
    csrf_protect._cookie_key = "csrf_token"  # pyright: ignore[reportPrivateUsage]
