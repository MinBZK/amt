...
#
#     source = page.locator("#card-container-1")
#     target = page.locator("#card-container-3")
#     # with page.expect_response("/project/move_task") as response_info:
#     page.drag_and_drop("#card-container-1", "#card-container-3", target_position={"x": 1, "y": 1})
#
